...
The application consists of a servlet annotated with URL-mappings, processing components, the main JSP view to present downloaded images, error pages, and a logged-out page.
